...
Дадайце адну ніжэй.',
	...
	'centralnotice-banner-fundraising-help' => 'Стварыце тэг спасылкі ў зьмесьце банэра з id="cn_fundraising_link" і пазначце адну ці некалькі мэтавых старонак, напрыклад, «JimmyAppeal01». Атрыбут HREF аўтаматычна набудзе патрэбную спасылку.',
