...
SELECT  nc_notice_id,  nc_country
FROM  /*_*/cn_notice_countries;
DROP  TABLE  /*_*/cn_notice_countries;
CREATE TABLE  /*_*/cn_notice_countries (    nc_notice_id INTEGER UNSIGNED NOT NULL,    nc_country VARCHAR(2) NOT NULL,    PRIMARY KEY(nc_notice_id, nc_country)  );
INSERT INTO  /*_*/cn_notice_countries (nc_notice_id, nc_country)
SELECT  nc_notice_id,  nc_country
FROM  /*_*/__temp__cn_notice_countries;
