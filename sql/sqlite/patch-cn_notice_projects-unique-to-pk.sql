...
SELECT  np_notice_id,  np_project
FROM  /*_*/cn_notice_projects;
DROP  TABLE  /*_*/cn_notice_projects;
CREATE TABLE  /*_*/cn_notice_projects (    np_notice_id INTEGER UNSIGNED NOT NULL,    np_project VARCHAR(32) NOT NULL,    PRIMARY KEY(np_notice_id, np_project)  );
INSERT INTO  /*_*/cn_notice_projects (np_notice_id, np_project)
SELECT  np_notice_id,  np_project
FROM  /*_*/__temp__cn_notice_projects;
